-- Native file explorer (built-in netrw, no plugin) — <leader>e opens a tree
-- view; selecting a file opens it in the previous window rather than
-- replacing the explorer split.
